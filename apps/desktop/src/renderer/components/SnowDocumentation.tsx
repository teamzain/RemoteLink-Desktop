    ...
    <div className="max-w-5xl mx-auto flex flex-col gap-10 animate-in fade-in slide-in-from-bottom-8 duration-700 font-inter pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
         {categories.map((cat, i) => (
           <div key={i} className="bg-white rounded-[32px] border border-[rgba(28,28,28,0.06)] p-8 shadow-sm hover:border-[rgba(28,28,28,0.2)] transition-all cursor-pointer group">
         ...
         <div className="bg-white rounded-[32px] border border-[rgba(28,28,28,0.06)] p-8 shadow-sm">
            ...
            <div className="space-y-4">
               {[
                 ...
                 <div key={k} className="flex items-center justify-between p-4 bg-[#F9F9FA] rounded-[24px] border border-[rgba(28,28,28,0.02)] hover:border-[rgba(28,28,28,0.1)] transition-all cursor-pointer group">
                    <div className="flex items-center gap-4">
                       <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-[rgba(28,28,28,0.3)] group-hover:text-black shadow-sm">
                          <item.icon size={18} />
                       </div>
